...
find install/lib/dotnet/ -maxdepth 1 -not -name "*.pdb" -type f -exec cp {} ${pluginDir}/Android/ \;
...
# Copy vendor libraries from opt/
find install/opt/ -name "*.so" -type f -exec cp {} ${pluginDir}/Android/ \;